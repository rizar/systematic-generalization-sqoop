...
bash scripts/train/mac_flatqa.sh --data_dir flatqa-letters-variety_1-repeats_4 --record_loss_every=1 --checkpoint_every=3 --num_iterations=8 --checkpoint_path=mac_flatqa

...
FULL_TEST_ARGS="--batch_size=2 --record_loss_every=1 --checkpoint_every=2 --num_iterations=5 --num_val_samples=4"
QUICK_TEST_ARGS="--batch_size=2 --record_loss_every=1 --num_iterations=1 --num_val_samples=4"
export NMN=`pwd`
